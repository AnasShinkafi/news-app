...
const Article = ({article}: Props) => {
  return (
    <article className='bg-slate-100 dark:bg-slate-800 flex flex-col rounded-lg shadow-lg md:shadow-xl hover:scale-105 hover:shadow-lg hover:bg-slate-200 transition-all duration-200 ease-out'>
        {article.image && (
